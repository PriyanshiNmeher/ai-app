...
function LeftHome() {
  ...
  return (
    <div className={`w-[25%] hidden lg:block h-[100vh] bg-[black] border-r-2 border-gray-900 overflow-auto ${showNotification?"overflow-hidden":"overflow-auto"}`}>
      <div className='w-full h-[100px] flex items-center justify-between p-[20px]'>
        ...
        {!showNotification && <><div className='flex items-center w-full justify-between px-[10px] gap-[10px] border-b-2 border-b-gray-900 py-[10px]'>
    ...
    <div className='text-blue-500 cursor-pointer font-semibold
