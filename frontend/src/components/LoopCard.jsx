...
function LoopCard({loop}) {
  ...
  return (
    <div className='w-full lg:w-[480px] h-[100vh] flex items-center justify-center border-l-2 border-r-2 border-gray-800 relative overflow-hidden'>
      ...
      <div ref={commentRef} className={`absolute z-[200] bottom-0 w-full h-[500px] p-[10px] rounded-t-4xl bg-[#0e1718] transition-transform duration-500 ease-in-out shadow-2xl shadow-black left-0 ${showComment?"translate-y-0":"translate-y-[100%] "}`}>
      ...
      <div className='w-full flex flex-col gap-[20px]'>
       ...
       { loop.comments?.map((com,index)=>(
        <div className='w-full min-w-[80px] flex flex-col gap-[5px] border-b-[1px] border-gray-800 justify-center pb-[10px] mt-[10px]'>
      ...
      <div className='w-full fixed bottom-0 h-[80px] flex items-center justify-between px-[10px] py-[20px]'>
           <div className='w-[30px] h-[30px] md:w-[40px] md:h-[40px] border-2 border-black rounded-full cursor-pointer overflow-hidden'>
                 ...
                 <input type="text" className='px-[10px] border-b-2 border-b-gray-500 text-white w-[90%] placeholder:text-white outline-none h-[40px]' placeholder='Write comment...' onChange={(e)=>setMessage(e.target.value)} value={message}/>
