...
<div className='flex items-center gap-[10px]'>
    {isMyProfile && userData._id === post.author._id && (
    <MdDelete
  ...
  {userData._id !=  post.author._id && <FollowButton tailwind={'px-[10px] md:min-w-[60px]  md:w-[100px] py-[5px] h-[30px] md:h-[40px] bg-[black] cursor-pointer text-white rounded-2xl text-[14px] md:text-[16px]'} targetUserId={post.author._id}/>}
     ...
     <div className='w-[90%]  flex items-center justify-center'>
         {post.mediaType=="image" && <div className='w-[90%] flex  items-center justify-center'>
             <img src={post.media} alt="" className=' w-[80%] rounded-2xl object-cover'/>
              ...
              {post.mediaType=="video" && <div className='w-[80%] flex flex-col items-center justify-center object-cover h-[400px]'>
         ...
         <div className='w-full h-[60px] flex justify-between items-center px-[20px] mt-[10px]'>
          <div className='flex justify-center items-center gap-[10px]'>
            ...
            <div className='flex justify-center items-center gap-[5px]'>
              ...
              {post.likes.includes(userData._id) && <GoHeartFill className='w-[25px] cursor-pointer h-[25px] text-red-600' onClick={handleLike}/>}<span>{post.likes.length}</span>
            </div>
