  ...
  return (
    <div className='w-full max-w-[500px] h-[100vh] border-x-2 border-gray-800 pt-[10px] relative flex flex-col justify-center'>
      ...
      <div className='absolute top-[10px] w-full h-[5px] bg-gray-900'>
        <div className='w-[200px] h-[5px] bg-white transition-all duration-200 ease-linear ' style={{width:`${progress}%`}}>
   ...
   <div className='w-full h-[90vh] flex items-center justify-center'>
         {storyData?.mediaType=="image" && <div className='h-full flex  items-center justify-center'>
             <img src={storyData?.media} alt="" className=' w-[80%] rounded-2xl object-cover'/>
              ...
              {storyData?.mediaType=="video" && <div className='h-[100%] flex flex-col items-center justify-center object-cover h-[400px]'>
        ...
        {storyData?.author?.userName==userData?.userName &&   <div className='w-full h-[70px] cursor-pointer p-2 left-0 flex items-center gap-[10px] text-white absolute bottom-0' onClick={()=>setShowViewers(true)}>
            <div className='text-white flex items-center gap-[5px]'><FaEye />{storyData?.viewers?.length}</div>
             ...
             <div className='flex relative'>
                                 ...
                                 <div key={viewer._id || index} className={`w-[30px] h-[30px]  border-2 border-black bg-black rounded-full cursor-pointer overflow-hidden ${index>0?'-ml-[28px]':""}`}>
       ...
       {showViewers && 
       <>
         <div className='w-full h-[30%] flex items-center cursor-pointer justify-center py-[30px] mt-[100px] overflow-hidden' onClick={()=>setShowViewers(false)}>
         {storyData?.mediaType=="image" && <div className='h-full flex items-center justify-center'>
             <img src={storyData?.media} alt="" className=' h-[80%] rounded-2xl object-cover'/>
    </div>}
     
              {storyData?.mediaType=="video" && <div className='w-[80%] flex flex-col items-center justify-center object-cover h-[400px]'>
            <VideoPlayer media={storyData?.media}/>
